...
const Footer = () => {
  ...
  return (
    <div className="app justify-center font-poppins">
      <div className="py-16 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 bg-black text-white w-full p-4 relative">
        <div className="  ">
          ...
          <div className="footer-icons flex items-center space-x-3">
            {socialLinks.map((socialLink, index) => {
              ...
              return (
                <Icon
                  key={`social-${index}`}
                  className="w-14 h-14 p-2 rounded-full bg-main_color_2 hover:bg-white hover:text-main_color_1 cursor-pointer"
                />
              );
            })}
          </div>
